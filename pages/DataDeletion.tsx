  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="text-center mb-12">
         ...
         <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">{t.deletion.title}</h1>
      ...
      <div className="bg-slate-900/50 backdrop-blur-lg border border-white/10 rounded-2xl p-6 md:p-8 shadow-xl mb-8">
        <h2 className="text-2xl font-bold text-white mb-6 border-b border-white/5 pb-4">{t.deletion.howToTitle}</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-slate-900 rounded-xl p-6 border border-white/5 hover:border-indigo-500/30 transition-colors">
                <div className="flex items-center gap-3 mb-4 text-indigo-400">
                    ...
                    <h3 className="text-lg font-bold">{t.deletion.emailMethodTitle}</h3>
                </div>
                ...
                <div className="mt-4 p-3 bg-slate-950 rounded border border-white/5">
                    <code className="text-cyan-400 text-sm select-all">support@oneiro.app</code>
                </div>
            </div>
        </div>
      </div>
      ...
      <div className="bg-red-950/20 border border-red-500/20 rounded-xl p-6 flex gap-4 items-start">
         ...
         <div>
             <h3 className="text-lg font-bold text-red-400 mb-2">{t.deletion.afterTitle}</h3>
             <p className="text-red-200/70 text-sm leading-relaxed">{t.deletion.afterContent}</p>
         </div>
      </div>
    </div>
  );
